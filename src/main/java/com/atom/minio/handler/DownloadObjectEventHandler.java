 ...
 */
@Component
public class DownloadObjectEventHandler implements EventHandler<Event> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DownloadObjectEventHandler.class);

    @Override
    public void handle(Event event) {
        LOGGER.info("........................start handle download object event........................");
