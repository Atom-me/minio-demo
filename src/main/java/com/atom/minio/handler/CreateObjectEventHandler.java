 ...
 */
@Component
public class CreateObjectEventHandler implements EventHandler<Event> {
    private static final Logger LOGGER = LoggerFactory.getLogger(CreateObjectEventHandler.class);

    @Override
    public void handle(Event event) {
        LOGGER.info("........................start handle create object event........................");
